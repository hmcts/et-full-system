...
require_relative './et1_pdf_file/base'
    ...
    module FileObjects
      ...
      class Et1PdfFile < BasePdfFile
        def has_correct_contents_for?(claim:, claimants:, respondents:, representative:, employment:)
          Et1PdfFileSection::OfficialUseOnlySection.new(tempfile).has_contents_for?(claim: claim,
                                                                                    respondent: respondents.first)
          Et1PdfFileSection::YourDetailsSection.new(tempfile).has_contents_for?(claimant: claimants.first, claim: claim)
