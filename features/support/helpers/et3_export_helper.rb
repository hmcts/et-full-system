    ...
    module Et3Export
      ...
      def calculated_response_matchers(args)
        [
          ...
          "~2.4 How would you prefer us to communicate with you?: #{factory_translate(
            args.dig(:respondent, :contact_preference), locale: :en
          ).downcase}",
          ...
          "~7.6 How would they prefer us to communicate with them?: #{factory_translate(
            args.dig(:representative, :representative_contact_preference), locale: :en
          ).downcase}",
