    ...
    module Diversity
      class SubmissionFormPage < BasePage
        ...
        def has_correct_data_populated?(diversity)
          ...
          unless data[:ethnicity_type].nil?
            expect(main_content.summary.ethnicity_type_row).to have_answer(text: data[:ethnicity_type])
          end
        ...
        def diversity_data?(diversity)
          diversity.to_h.each_with_object({}) do |(k, v), acc|
