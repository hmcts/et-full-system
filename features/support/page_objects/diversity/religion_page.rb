    ...
    module Diversity
      class ReligionPage < BasePage
        ...
        section :main_content, '.container' do
          ...
          section :christian, :form_labelled,
                  'religion.christian-including-church-of-england-catholic-protestant-and-all-other-christian-denominations' do
            element :field, 'input'
            def set(*args) = field.set(*args)
          end
