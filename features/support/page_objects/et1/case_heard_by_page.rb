  ...
  module Test
    module Et1
      class CaseHeardByPage < BasePage
        ...
        def fill_in_all(claim:)
          fill_in_case_heard_by(claim:)
          self
        end

        # Fills in the claim data
        # @param [Claim] claimant The claimant
        def fill_in_case_heard_by(claim:)
          case_heard_by_preference_question.set(claim.case_heard_by_preference)
          return unless claim.case_heard_by_preference.to_s.split('.').last.in?(%w[judge panel])

          case_heard_by_preference_reason_question.set(claim.case_heard_by_preference_reason)
        end
        ...
        gds_radios :case_heard_by_preference_question, :'claims.case_heard_by.case_heard_by_preference'
        ...
        gds_text_area :case_heard_by_preference_reason_question, :'claims.case_heard_by.case_heard_by_preference_reason'
