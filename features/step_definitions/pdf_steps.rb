...
Given('an employee making a claim against {string} respondents') do |_string|
...
Given('an employee making a claim with joint claim ACAS number') do
  ...
  @respondent = FactoryBot.create_list(:respondent, 1, :no_acas, :both_addresses, :no_acas, :both_addresses,
                                       work_post_code: 'G1 2FF', expected_office: '41')
  @employment = FactoryBot.create(:employment, :still_employed)
  @claim = FactoryBot.create(:claim, :yes_to_whistleblowing_claim)
end
...
Given('an employee making a claim with no jurisdiction') do
  ...
  @representative = FactoryBot.create_list(:representative, 1, :et1_information)
  @respondent = FactoryBot.create_list(:respondent, 1, :no_acas, :both_addresses, :no_acas, :both_addresses,
                                       no_acas_number_reason: :"simple_form.options.respondent.no_acas_number_reason.acas_has_no_jurisdiction", work_post_code: 'G1 2FF', expected_office: '41')
  @employment = FactoryBot.create(:employment, :still_employed)
  @claim = FactoryBot.create(:claim, :yes_to_whistleblowing_claim)
end
...
Given('an employee making a claim with employer contacted ACAS') do
  ...
  @representative = FactoryBot.create_list(:representative, 1, :et1_information)
  @respondent = FactoryBot.create_list(:respondent, 1, :no_acas, :both_addresses, :no_acas, :both_addresses,
                                       no_acas_number_reason: :"simple_form.options.respondent.no_acas_number_reason.employer_contacted_acas", work_post_code: 'G1 2FF', expected_office: '41')
  @employment = FactoryBot.create(:employment, :still_employed)
  @claim = FactoryBot.create(:claim, :yes_to_whistleblowing_claim)
end
...
Given('an employee making a claim with interim relief') do
  ...
  @representative = FactoryBot.create_list(:representative, 1, :et1_information)
  @respondent = FactoryBot.create_list(:respondent, 1, :no_acas, :both_addresses, :no_acas, :both_addresses,
                                       no_acas_number_reason: :"simple_form.options.respondent.no_acas_number_reason.interim_relief", work_post_code: 'G1 2FF', expected_office: '41')
  @employment = FactoryBot.create(:employment, :still_employed)
  @claim = FactoryBot.create(:claim, :yes_to_whistleblowing_claim)
end
...
Given('an employee making a claim against an employer who is not aware of pension scheme') do
  ...
  @representative = FactoryBot.create_list(:representative, 1, :et1_information)
  @respondent = FactoryBot.create_list(:respondent, 1, :yes_acas, :both_addresses)
  @employment = FactoryBot.create(:employment, :notice_period, claimant_employed_currently: 'Yes')
  @claim = FactoryBot.create(:claim, :yes_to_whistleblowing_claim)
end
